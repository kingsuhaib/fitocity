...
public class WelcomeScreen extends JFrame implements ActionListener{
	...
	WelcomeScreen(){
		...
		descp.setText("<html>Fitocity is a health and fitness management system. Built<br></br>"
				+ "using the advanced design and development standards, fitocity works one "
				+ "sidely and assists it's users with their health and fitness needs intelligently.</html>");
		descp.setFont(new Font("Roboto Regular", Font.BOLD, 18));
		descp.setBounds(625,250,550,400);
